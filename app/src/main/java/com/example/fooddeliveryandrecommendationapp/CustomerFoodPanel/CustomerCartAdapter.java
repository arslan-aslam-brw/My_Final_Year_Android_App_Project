...
public class CustomerCartAdapter extends RecyclerView.Adapter<CustomerCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.PriceRs.setText("Price: PKR " + cart.getPrice());
        holder.Qty.setText("× " + cart.getDishQuantity());
        holder.Totalrs.setText("Total: PKR " + cart.getTotalprice());
        ...
        holder.elegantNumberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            ...
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                ...
                if (num != 0) {
                    ...
                    hashMap.put("SellerId",cart.getSellerId());
        ...
        CustomerCartFragment.grandt.setText("Grand Total: PKR " + total);
