...
public class CustomerCartFragment extends Fragment {
    ...
    String DishId, RandomUId, SellerId;
                                                ...
                                                group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                                    ...
                                                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                                                        if (home.isChecked()) {
                                                            ...
                                                            localaddress.setText(customer.getLocalAddress() + ", " + customer.getLocation());
                                                        ...
                                                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                                                    ...
                                                                    hashMap.put("SellerId", cart1.getSellerId());
                                                                                                ...
                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                            ...
                                                                                                            String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                                                                                            SellerId = customerPendingOrders.getSellerId();
                                                                                                            ...
                                                                                                            FirebaseDatabase.getInstance().getReference("SellerPendingOrders").child(SellerId).child(RandomUId).child("Dishes").child(d).setValue(hashMap2);
                                                                                                        }
                                                                                                        ...
                                                                                                        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                            ...
                                                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                ...
                                                                                                                FirebaseDatabase.getInstance().getReference("SellerPendingOrders").child(SellerId).child(RandomUId).child("OtherInformation").setValue(hashMap3).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                    @Override
