...
public class ChooseOne extends AppCompatActivity {
    ...
    Button Seller, Customer, DeliveryPerson;
    Intent intent;
    String type;
        ...
        Seller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (type.equals("Email")) {
                    Intent loginemail = new Intent(ChooseOne.this, SellerLogin.class);
                    startActivity(loginemail);
                    finish();
                }
                if (type.equals("Phone")) {
                    Intent loginphone = new Intent(ChooseOne.this, Sellerloginphone.class);
                    startActivity(loginphone);
                    finish();
                }
                if (type.equals("SignUp")) {
                    Intent Register = new Intent(ChooseOne.this, SellerRegisteration.class);
