...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    String RandomUID;
    TextView grandtotal, address, name, number, SellerName;
    LinearLayout l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SellerName =(TextView)findViewById(R.id.chefname);
    ...
    private void deliveryorders() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("PKR " + deliveryShipOrders1.getGrandTotalPrice());
                address.setText(deliveryShipOrders1.getAddress());
                name.setText(deliveryShipOrders1.getName());
                number.setText("+92" + deliveryShipOrders1.getMobileNumber());
                SellerName.setText("Seller "+ deliveryShipOrders1.getSellerName());
