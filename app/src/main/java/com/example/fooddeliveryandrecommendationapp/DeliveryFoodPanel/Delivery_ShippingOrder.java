...
public class Delivery_ShippingOrder extends AppCompatActivity {
    ...
    TextView Address, SellerName, grandtotal, MobileNumber, Custname;
    Button Call, Shipped;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SellerName = (TextView) findViewById(R.id.chefname2);
    ...
    private void Shipped() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("PKR " + deliveryShipFinalOrders1.getGrandTotalPrice());
                Address.setText(deliveryShipFinalOrders1.getAddress());
                Custname.setText(deliveryShipFinalOrders1.getName());
                MobileNumber.setText("+92" + deliveryShipFinalOrders1.getMobileNumber());
                SellerName.setText("Seller " + deliveryShipFinalOrders1.getSellerName());
                userid = deliveryShipFinalOrders1.getUserId();
                Sellerid = deliveryShipFinalOrders1.getSellerId();
                            ...
                            public void onSuccess(Void aVoid) {
                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        sendNotifications(usertoken, "Home Seller", "Thank you for Ordering", "ThankYou");
                                    }
