...
import com.example.fooddeliveryandrecommendationapp.SellerFoodPanel.SellerPreparedOrderView;
import com.example.fooddeliveryandrecommendationapp.SellerFoodPanel_BottomNavigation;
import com.example.fooddeliveryandrecommendationapp.CustomerFoodPanel.PayableOrders;
import com.example.fooddeliveryandrecommendationapp.CustomerFoodPanel_BottomNavigation;
import com.example.fooddeliveryandrecommendationapp.Delivery_FoodPanelBottomNavigation;
import com.example.fooddeliveryandrecommendationapp.MainActivity;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        ...
        if (page.trim().equalsIgnoreCase("Order")) {
            acIntent = new Intent(context, SellerFoodPanel_BottomNavigation.class).putExtra("PAGE", "Orderpage");
        ...
        if (page.trim().equalsIgnoreCase("Confirm")) {
            acIntent = new Intent(context, SellerFoodPanel_BottomNavigation.class).putExtra("PAGE", "Confirmpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("AcceptOrder")) {
            acIntent = new Intent(context, SellerFoodPanel_BottomNavigation.class).putExtra("PAGE", "AcceptOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        if (page.trim().equalsIgnoreCase("RejectOrder")) {
            acIntent = new Intent(context, SellerPreparedOrderView.class).putExtra("PAGE", "RejectOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("Delivered")) {
            acIntent = new Intent(context, SellerFoodPanel_BottomNavigation.class).putExtra("PAGE", "Deliveredpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }


        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context, CHANNEL_ID).setSmallIcon(R.drawable.ic_seller_hat_and_fork)
