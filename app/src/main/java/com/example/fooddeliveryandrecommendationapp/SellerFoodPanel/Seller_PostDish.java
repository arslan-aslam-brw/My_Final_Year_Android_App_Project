...
public class Seller_PostDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller__post_dish);
        ...
        try {
            ...
            dataaa = firebaseDatabase.getInstance().getReference("Seller").child(userid);
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(Seller_PostDish.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            FoodSupplyDetails info = new FoodSupplyDetails(dishes, quantity, price, description, String.valueOf(uri), RandomUId, SellerId);
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Seller_PostDish.this, "Dish posted successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Seller_PostDish.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
