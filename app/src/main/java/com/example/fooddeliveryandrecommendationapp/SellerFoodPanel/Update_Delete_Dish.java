...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    String description, quantity, price, dishes, SellerId;
    String RandomUId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Seller sellerc = dataSnapshot.getValue(Seller.class);
                State = sellerc.getState();
                City = sellerc.getCity();
                Sub = sellerc.getLocation();
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        startActivity(new Intent(Update_Delete_Dish.this, SellerFoodPanel_BottomNavigation.class));
                                    }
                                });
    ...
    private void updatedesc(String uri) {
        ...
        FoodSupplyDetails info = new FoodSupplyDetails(dishes, quantity, price, description, uri, ID, SellerId);
